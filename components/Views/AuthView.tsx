...
export default function AuthView() {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-100 flex items-center justify-center p-4 sm:p-6 lg:p-12">
      <div className="w-full max-w-4xl bg-white rounded-xl shadow-xl border border-slate-200 overflow-hidden grid grid-cols-1 lg:grid-cols-12 min-h-[580px]">
        {/* Left / Form Section (7 cols on desktop) */}
        ...
        {/* Right / Hero Illustration Section (5 cols on desktop) */}
        <div className="hidden lg:flex lg:col-span-5 bg-slate-900 p-8 flex-col justify-between text-slate-200 relative overflow-hidden border-l border-slate-800">
          <div className="relative z-10 space-y-4">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-800 border border-slate-700 text-xs font-semibold text-slate-300">
              ...
              <span>Técnica Pomodoro 2.0</span>
            </div>
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              Elimine distrações, sincronize seu fluxo de trabalho entre dispositivos e acompanhe seu progresso com métricas inteligentes.
            </p>
          </div>

          <div className="relative z-10 space-y-3 pt-6">
            {[
              'Banco de dados persistente e sincronizado',
              'Gestão integrada de Projetos e Tarefas',
              'Sessões de Foco imersivas com áudio relaxante',
          ...
          <div className="relative z-10 pt-6 border-t border-slate-800 flex items-center justify-between text-[11px] text-slate-400">
            <span>Flow Productivity Suite</span>
